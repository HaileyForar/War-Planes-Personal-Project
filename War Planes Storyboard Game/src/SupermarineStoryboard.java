...
public class SupermarineStoryboard
	{
		...
		{
			System.out.println();
			System.out.println("You have chosen the British Supermarine Spitfire!");
			System.out.println();
			...
			System.out.println();
			System.out.println("I guess you want to fight in World War II then? No? Well, you might want to buckle your seatbelt. It's going to be a wild ride.");
			System.out.println("The year is 1942, right in the midst of the war. You are a pilot, the finest in the Royal Air Force.");
		...
		public static void firstDecision()
		{
			...
			System.out.println();
			System.out.println("You are currently stationed in the middle of France, and are getting ready to fly off to fight.");
			...
			System.out.println();
			System.out.println("1. Disobey orders and make sure that your plane is really good to go fly across to the frontlines?");
			...
			if(choice == 1)
				{
					...
					System.out.println("Get ready, you are now on your way to the fight!");
					stillPlaying = false;
				}
			
			else if(choice == 2)
				{
					System.out.println("Wrong choice Rookie, once you started to cross the country, panels of your wings started to peel off because the bolts were not tight.");
					System.out.println("Have fun falling, down, down, d..o..w..n...");
		...
		public static void secondDecision()
		{
			...
			System.out.println();
			System.out.println("Alright Lieutenant, you are now across the country. You had safe travels.");
		...
		public static void thirdDecision()
		{
			...
			System.out.println("It is an extremely dangerous mission and it would take at least two and a half days to get there and back.");
		...
		public static void fourthDecision()
		{
			...
			int timeDelay = 10;
			System.out.print("FOURTH CHOICE LOADING");
			try        
			{
				for(int i = 0; i < timeDelay; i++)
				{
			...
			System.out.println("Your commanding officer is ordering an air attack on London.");
			System.out.println("During your training you were extremely good at undercover air strikes");
            System.out.println("Do you want to proceed with the air attack or argue that it isn't necessary");
			System.out.println("What do you do?");
			System.out.println("1. Do you agree to take the job, and put your skills to the test through bombing London in the dead of night?");
			System.out.println("2. Or do you argue and possibly get suspended and the air strike happen anyway?");
			Scanner intInput = new Scanner (System.in);
			int choice = intInput.nextInt();
			...
			if(choice == 1)
				{
					System.out.println("It looks like your efforts payed off Lieutenant. You were able to strike some valuable factories and depots. The British seem to have retreated. The end looks near");
					System.out.println();
					System.out.println("Congradulations, you made it to the end of WWII, and earned your wings in the Royal Flying Corps.");
				...
				{
					System.out.println("You stayed to argue because you didn't think the strike was necessary, but you were suspended and the air strike happened anyway.");
					System.out.println("GAME OVER.");
					stillPlaying = false;
				}
