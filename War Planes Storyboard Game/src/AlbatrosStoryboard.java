...
public class AlbatrosStoryboard
	{
		...
		{
			System.out.println();
			System.out.println("You have chosen the German Albatros B.1!");
			System.out.println();
			...
			System.out.println("The year is 1916, right in the midst of the war. You are a pilot, the finest in the German Air Force.");
		...
		public static void firstDecision()
		{
			...
			System.out.println();
			System.out.println("You are currently stationed outside Berlin, and are getting ready to fly off to fight.");
			...
			if(choice == 1)
			...
			else if(choice == 2)
				{
					...
					System.out.println("Have fun falling from the sky.");
		...
		public static void secondDecision()
		{
			...
			System.out.println("You have been staying at a base in the outskirts of France for a few days, and things have been pretty quiet.");
			...
			System.out.println("Through looking up, you can't see the planes overhead, but you can see the insignia on the side, and your heart drops as you realize it is a British Squadron.");
		...
		public static void fourthDecision()
		{
			...
			System.out.println("We need someone to sneak through the city and get this letter with British plans on it to an agent who will be waiting along the single road out of Paris.");
			...
			if(choice == 1)
				{
					System.out.println("It looks like your efforts payed off Lieutenant. We were able to thwart a massive British raid and it looks like the end of The Great War is nigh.");
					System.out.println();
					System.out.println("Congradulations, you made it to the end of WWI, and earned your wings in the German Air Force.");
