...
public class SuperfortressStoryboard
	{
		...
		{
			System.out.println("You have chosen the American B29 Superfortress!");
			...
			System.out.println("The year is 1942, right in the midst of the war. You are a pilot, the finest in the Air Force.");
		...
		public static void ending()
		{
			...
			System.out.println("Congradulations, you made it to the end of WWII, and earned your wings in the United States Air Force.");
