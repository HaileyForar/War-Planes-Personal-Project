...
public class SuperfortressStoryboard
	{
		...
		{
			System.out.println();
			System.out.println("You have chosen the American B-29 Superfortress!");
			System.out.println();
			...
			System.out.println("The year is 1942, right in the midst of the war. You are a pilot, the finest in the United States Air Force (USAF).");
		...
		public static void firstDecision()
		{
			...
			System.out.println();
			System.out.println("You are currently stationed in Hawaii, Pearl Harbor, and are getting ready to fly off to fight.");
			...
			System.out.println();
			System.out.println("1. Disobey orders and make sure that your plane is really good to go fly across to a small Island base off of the Phillipeans?");
			...
			if(choice == 1)
				{
					...
					System.out.println("Get ready, you are now on your way to the base!");
					stillPlaying = false;
				}
			
			else if(choice == 2)
				{
					System.out.println("Wrong choice Rookie, once you started to cross the Ocean, panels of your wings started to peel off because the bolts were not tight.");
		...
		public static void secondDecision()
		{
			...
			System.out.println();
			System.out.println("Alright Lieutenant, you are now across the ocean. You had safe travels.");
			...
			System.out.println("You have been staying at a base in the Phillipeans for a few days, and things have been pretty quiet.");
			...
			System.out.println("Through looking up, you can't see the planes overhead, but you can see the insignia on the side, and your heart drops as you realize it is a Japanese Squadron.");
		...
		public static void thirdDecision()
		{
			...
			System.out.println("One of the only things to do is take a convoy and try to connect with another base through the island on the far side.");
		...
		public static void fourthDecision()
		{
			...
			System.out.println("Since your base was decimated, there are very few planes left on the island, so you have been recruited for another job.");
			System.out.println("During your training you were extremely good at undercover work, so here is a proposition...");
			System.out.println("We need someone to fly an undercover mission to Pearl Harbor and get a letter to the head over there. They will know what to do from there.");
			System.out.println("What do you do?");
			...
			if(choice == 1)
				{
					System.out.println("It looks like your efforts payed off Lieutenant. We were able to thwart a massive Japenese attack and it looks like the end of The Great War is nigh.");
					System.out.println();
