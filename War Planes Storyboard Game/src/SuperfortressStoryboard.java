...
public class SuperfortressStoryboard
	{
		...
		{
			System.out.println("You have chosen the B-29 Superfortress!");
			...
			System.out.println("The year is 1916, right in the midst of the war. You are a pilot, the finest in the United States Air Force (USAF).");
