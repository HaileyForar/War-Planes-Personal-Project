...
public class AEGStoryboard
	{
		...
		{
			System.out.println();
			System.out.println("You have chosen the German AEG G.IV!");
			System.out.println();
		...
		public static void firstDecision()
		{
			...
			System.out.println("1. Disobey orders and make sure that your plane is really good to go fly across to the British frontlines?");
			...
			if(choice == 1)
			...
			else if(choice == 2)
				{
					...
					System.out.println("Have fun plummeting to your death.");
		...
		public static void secondDecision()
		{
			...
			System.out.println("Through looking up, you can't see the planes overhead, but you can see the insignia on the side, and your heart drops as you realize it is a British Squadron who launched an air attack before you could get into the sky.");
